...
除非需要维护遗留代码库，否则请避免使用 Python 2：

-   从 Python 历史时间线可以看出，Python 2 和 Python 3 已经同时开发和维护了很长一段时间。主要原因是 Python 3 代码与 Python 2 代码并不完全向后兼容。这种不兼容性导致采用率延长。许多人对版本 2 很满意，没有理由升级。
-   除此之外，Python 3 最初比 Python 2 慢。随着 Python 3 不断改进并添加新功能，它最终一飞冲天。在 Guido 领导的最新努力下，Python 3 现在比以往任何时候都快。
-   此外，Python 3 为该语言添加了许多有用的功能，使其更简单、更有趣。
